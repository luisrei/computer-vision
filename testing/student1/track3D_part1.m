%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                        %
%  Function script - PIV project (Part 1)                                %
%                                                                        %
%  The transformations (R1,T1,R2,T2) are known, the function             %
%  receives the images and the transformations as inputs and  returns    %
%  the 8 points describing the time trajectories of the enclosing box of %
%  the objects in world coordinates                                      %
%                                                                        %
...
gradient_threshold = 150; % Assumed object is never > 15cm in depth
...
%                                                           Background
% --------------------------------------------------------------------
[bgd1] = get_bg(imgseq1); % camera 1
[bgd2] = get_bg(imgseq2); % camera 2
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                        %
%  Function script - Project image to 3D                                 %
%                                                                        %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% good_inds - indexes of the image that are valid, i.e., different from 0.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                        %
%  Function script - Combine rgb + depth                                 %
%                                                                        %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
rgb_aux = reshape(rgb,length(rgb(:,1,:))*length(rgb(1,:,:)),3);
...
ims = zeros(length(depth_array(:,1))*length(depth_array(1,:)),numel(new_imgseq));
imsd = ims;

% Construct array with rgb and depth info
for i = 1:numel(new_imgseq)
    im_aux = imread(new_imgseq(i).rgb);
    % make grayscale
    if size(im_aux,3) > 1,
        im = rgb2gray(im_aux);
    else
...
bgim = (uint8(reshape(medim,[length(depth_array(:,1)) length(depth_array(1,:))])));
